...
@Database(entities = [GunungEntity::class, GunungJawaBaratEntity::class, GunungJawaTengahEntity::class, GunungJawaTimurEntity::class, FeedbackItemEntity::class, UserLoginEntity::class, GunungRecommendationEntity::class], version = 1, exportSchema = false)
